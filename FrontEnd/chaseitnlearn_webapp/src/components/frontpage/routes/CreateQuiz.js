...
function CreateQuiz(){
  ...
  <input type="text" id="quiz-title" name="quiz-title"/><br>
  </br>
  <div id="questions">
    <div class="question">
      <label for="question-1">Question 1:</label><br/>
      <input type="text" id="question-1" name="question-1"/><br>
      </br>
      <label for="answer-1-1">Answer 1:</label><br/>
      <input type="text" id="answer-1-1" name="answer-1-1"/><br>
      </br>
      <label for="answer-1-2">Answer 2:</label><br/>
      <input type="text" id="answer-1-2" name="answer-1-2"/><br>
      </br>
      <label for="answer-1-3">Answer 3:</label><br/>
      <input type="text" id="answer-1-3" name="answer-1-3"/><br>
      </br>
      <label for="answer-1-4">Answer 4:</label><br/>
      <input type="text" id="answer-1-4" name="answer-1-4"/><br>
      </br>
